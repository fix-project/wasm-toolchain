...
mkdir -p ${INST}/lib/clang/18/lib/wasi
ln -s ${INST}/lib/clang/18/lib/wasm32-wasi/libclang_rt.builtins.a ${INST}/lib/clang/18/lib/wasi/libclang_rt.builtins-wasm32.a
