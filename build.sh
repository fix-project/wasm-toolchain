...
cd ${SRC}/wasix
export WASI_SDK_PATH="/home/yuhan/wasm-toolchain/sysroot"
export WASI_SYSROOT="/home/yuhan/wasm-toolchain/sysroot"
export DESTDIR="/home/yuhan/wasm-toolchain/sysroot/wasix"
make install
